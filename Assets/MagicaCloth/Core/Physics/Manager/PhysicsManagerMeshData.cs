...
namespace MagicaCloth
{
    ...
    public class PhysicsManagerMeshData : PhysicsManagerAccess
    {
        ...
        public struct RenderMeshInfo
        {
            ...
            {
                //Debug.Log("AddLInkMesh[" + renderMeshIndex + "] (childMeshVertexStart:" + childMeshVertexStart + ",childMeshWeightStart:" + childMeshWeightStart + ",virtualMeshVertexStart:" + virtualMeshVertexStart + ",sharedVirtualMeshVertexStart:" + sharedVirtualMeshVertexStart);

                for (int i = 0; i < MaxRenderMeshLinkCount; i++)
                {
                    if (childMeshVertexStartIndex[i] == childMeshVertexStart && virtualMeshVertexStartIndex[i] == virtualMeshVertexStart)
                    {
                        // 利用カウントアップ
                        linkMeshCount[i]++;
            ...
            {
                //Debug.Log("RemoveLinkMesh[" + renderMeshIndex + "] (childMeshVertexStart:" + childMeshVertexStart + ",childMeshWeightStart:" + childMeshWeightStart + ",virtualMeshVertexStart:" + virtualMeshVertexStart + ",sharedVirtualMeshVertexStart:" + sharedVirtualMeshVertexStart);
